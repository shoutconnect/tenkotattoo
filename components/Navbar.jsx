      ...
      <div className="margin-x w-full flex justify-between items-start">
        ...
        <div className="flex items-start gap-4">
            ...
            {menuItems.map((item, i) => (
              <Link href={item.href} key={i} className=" mt-1">
                <div className="pt-1 px-2 group flex flex-col gap-1">
                  <p className="mx-1.5 uppercase font-extrabold text-neutral-600 group-hover:text-[#ed028c]">
                    {item.name}
                  </p>{" "}
                  <div className="group-hover:bg-[#ed028c] bg-neutral-50 my-transition h-1 w-full " />
                </div>
              </Link>
            ))}
          </div>
          ...
          <Btn
            text={
              <>
                <span className="text-[#ed028c] duration-300 delay-200 group-hover:text-neutral-50 ease">
                  GET
                </span>
